...
import RegularAdultLinks from 'rfa_forms/tracking/sidebar/regularAdultLinks'
import {REGULAR_PERSON_TYPE} from 'rfa_forms/tracking/trackingSideBar'
...
describe('RFA 01a tracking sidebar applicant links ', () => {
  ...
  beforeEach(() => {
    ...
    component = mount(<RegularAdultLinks
  ...
  it('renders a link to the Applicant Information card', () => {
    expect(component.find('NavLink[text="present adult"]').props().href)
      .toBe('#PresentAdult3-tracking-card')
  })
  it('clicks the link and updates link to the Applicant Information card', () => {
    component.find('Link[text="present adult"]').simulate('click')
    component.update()
