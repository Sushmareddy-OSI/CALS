...
import ApplicantLinks from 'rfa_forms/tracking/sidebar/applicantLinks'
import {APPLICANT_PERSON_TYPE} from 'rfa_forms/tracking/trackingSideBar'
...
describe('RFA 01a tracking sidebar applicant links ', () => {
  ...
  beforeEach(() => {
    ...
    component = mount(<ApplicantLinks
  ...
  it('renders a link to the Applicant Information card', () => {
    expect(component.find('NavLink[text="0one 0person"]').props().href)
      .toBe('#Applicant0-tracking-card')
  })
  it('clicks the link and updates link to the Applicant Information card', () => {
    component.find('Link[text="0one 0person"]').simulate('click')
    component.update()
